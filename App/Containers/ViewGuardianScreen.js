...
class ViewGuardianScreen extends Component {
  ...
  getEmailBody (data) {
    return 'Abuse reported for guardian: ' + this.props.navigation.state.params +
  ...
  sendMail (data) {
    ...
    sendEmail('nikitph@gmail.com', 'Someone Left a feedback', emailBody).then((response) => {
      if (response.ok) {
      ...
      <Animatable.View style={styles.container} animation='fadeIn'>
        ...
        <ScrollView style={{flexGrow: 1}}>
          ...
          <View style={{flex: 0.1, alignItems: 'flex-end'}}>
            <TouchableOpacity style={[styles.headerIconContainer, {margin: 10}]}
